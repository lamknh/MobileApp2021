...
class worldcup_fast1 : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.worldcup_fast1)
        // round 체크
        var round = 8
        var now = 1
        var select = 0
        var next = 2
        // 음식 렌덤 이미지 8개
        var FoodImage = intArrayOf(R.drawable.burrito , R.drawable.chicken, R.drawable.hamburger,
            R.drawable.hotdog, R.drawable.pizza, R.drawable.sandwich, R.drawable.takoyaki, R.drawable.toast)
        ...
        // 음식  이름
        var FoodName = arrayOf("브리또","치킨","햄버거","핫도그","피자","샌드위치","타코야끼", "토스트")
        ...
        left.setOnClickListener {
            ...
            {
                voteCount[select]++
                var nextintent = Intent(this, worldcup_fast2::class.java)

...
class worldcup_des1 : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var next = 2
        // 음식 렌덤 이미지 8개
        var FoodImage = intArrayOf(R.drawable.bread , R.drawable.cake, R.drawable.coffee,
            R.drawable.donut, R.drawable.icecream, R.drawable.macarons, R.drawable.toast, R.drawable.waffle)

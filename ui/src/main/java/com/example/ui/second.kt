...
class second : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ko_food.setOnClickListener{
            var goto_kr = Intent(applicationContext, worldcup_ko::class.java)
            startActivity(goto_kr)
            finish()
        }

        jp_food.setOnClickListener{
//                    var goto_jp = Intent(applicationContext, worldcup_jp::class.java)
//                    startActivity(goto_jp)
//                   finish()
        }

        ch_food.setOnClickListener{
//                    var goto_ch = Intent(applicationContext, worldcup_ch::class.java)
//                        startActivity(goto_ch)
//                        finish()
        }

        fast_food.setOnClickListener{
//                        var goto_fast = Intent(applicationContext, worldcup_fast::class.java)
//                        startActivity(goto_fast)
//                        finish()
        }

        west_food.setOnClickListener{
//                        var goto_west = Intent(applicationContext, worldcup_west::class.java)
//                        startActivity(goto_west)
//                        finish()
        }

        world_food.setOnClickListener{
//                        var goto_world = Intent(applicationContext, worldcup_world::class.java)
//                        startActivity(goto_world)
//                        finish()
        }

        snack.setOnClickListener{
//                        var goto_snack = Intent(applicationContext, worldcup_snack::class.java)
//                        startActivity(goto_snack)
//                        finish()
        }

        dessert.setOnClickListener{
//            var goto_dessert = Intent(applicationContext, worldcup_dessert::class.java)

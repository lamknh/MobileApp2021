...
class  worldcup_dessert : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.food_worldcup)
        // round 체크
        var round = 8
        var now = 1
        var select = 0
        ...
        var cupmaintext = arrayOf("4강 1/4","4강 2/4","4강 3/4","4강 4/4" )
        // left, right 버튼
        ...
        left.setOnClickListener {
            ...
            {
                voteCount[select]++
                var nextintent = Intent(this, SelectFood::class.java)

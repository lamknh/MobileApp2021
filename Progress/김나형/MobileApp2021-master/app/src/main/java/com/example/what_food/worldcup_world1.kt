...
class worldcup_world1 : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var next = 2
        // 음식 렌덤 이미지 8개
        var FoodImage = intArrayOf(R.drawable.burrito , R.drawable.curry, R.drawable.malacrawfish,
            R.drawable.padthai, R.drawable.pilaf, R.drawable.taco, R.drawable.tandoori_chicken, R.drawable.vietnam_noddle)
        ...
        // 음식  이름
        var FoodName = arrayOf("브리또","카레","칠리 새우","팟타이","필라프","타코","탄두리 치킨","쌀국수")

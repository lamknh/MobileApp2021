...
class worldcup_jp1 : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.worldcup_jp1)
        // round 체크
        var round = 8
        var now = 1
        var select = 0
        var next = 2
        // 음식 렌덤 이미지 8개
        var FoodImage = intArrayOf(R.drawable.onigiri, R.drawable.ramen, R.drawable.sashimi,
            R.drawable.soba, R.drawable.sushi, R.drawable.takoyaki, R.drawable.tonkatsu, R.drawable.udong)
        ...
        // 음식  이름
        var FoodName = arrayOf("오니기리","라멘","회","소바","스시","타코야끼","돈까스", "우동")
        ...
        left.setOnClickListener {
            ...
            {
                voteCount[select]++
                var nextintent = Intent(this, worldcup_jp2::class.java)

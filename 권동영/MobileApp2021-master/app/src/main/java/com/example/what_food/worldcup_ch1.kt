...
class worldcup_ch1 : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.worldcup_ch1)
        // round 체크
        var round = 8
        var now = 1
        var select = 0
        var next = 2
        // 음식 렌덤 이미지 8개
        var FoodImage = intArrayOf(R.drawable.bbokumbab , R.drawable.dimsum, R.drawable.dongpayuk,
            R.drawable.lambggochi, R.drawable.malacrawfish, R.drawable.tangsuyuk, R.drawable.zzambbong, R.drawable.zzazangmeon)
        ...
        // 음식  이름
        var FoodName = arrayOf("볶음밥","딤섬","동파육","양꼬치","마라새우","탕수육","짬뽕", "짜장면")

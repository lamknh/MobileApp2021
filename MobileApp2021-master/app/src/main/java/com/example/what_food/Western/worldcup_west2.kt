package com.example.what_food.Western
//4강
...
import com.example.what_food.Korean.worldcup_kof
import com.example.what_food.R
import com.example.what_food.CategoryActivity

class worldcup_west2 : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.worldcup_west2)
//초기버튼 정의 및 실행
        ...
        left.setOnClickListener {
            ...
            {
                newVote[select]++
                var nextintent1 = Intent(this, worldcup_kof::class.java)
        ...
        right.setOnClickListener {
            ...
            {
                newVote[select + 1]++
                var nextintent1 = Intent(this, worldcup_westf::class.java)
                nextintent1.putExtra("VoteCount1", newVote)
                nextintent1.putExtra("ImageName1", newName)
                nextintent1.putExtra("WinFoodImage", newFoodImage)
                startActivity(nextintent1)

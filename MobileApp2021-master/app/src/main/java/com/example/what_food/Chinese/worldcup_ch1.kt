package com.example.what_food.Chinese
//8강
...
class worldcup_ch1 : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var FoodImage = intArrayOf(
            R.drawable.bbokumbab,
            R.drawable.dimsum,
            R.drawable.dongpayuk,
            R.drawable.lambggochi,
            R.drawable.malacrawfish,
            R.drawable.tangsuyuk,
            R.drawable.zzambbong,
            R.drawable.zzazangmeon
        )
